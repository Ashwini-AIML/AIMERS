...
df=pd.read_csv("D:/Ashwini/AIMERS/disease csv/Prototype.csv")
#Read a csv named Testing.csv
tr=pd.read_csv("D:/Ashwini/AIMERS/disease csv/Prototype-1.csv")
...
def DecisionTree():
    ...
    print("Accuracy score - DecisionTree :",accuracy_score(y_test, y_pred))
    print("Accuracy value - DecisionTree :",accuracy_score(y_test, y_pred,normalize=False))
...
def randomforest():
    ...
    print("Accuracy value - randomforest :",accuracy_score(y_test, y_pred,normalize=False))
...
def NaiveBayes():
    ...
    print("Accuracy score - NaiveBayes :",accuracy_score(y_test, y_pred))
    print("Accuracy value - NaiveBayes :",accuracy_score(y_test, y_pred,normalize=False))
...
w2 = Label(root, text="Choose symptoms to know the predictions", justify=LEFT)
w2.config(font=("Times",30))
...
destreeLb.config(font=("Times",15))
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes")
ranfLb.config(font=("Times",15))
...
rnf.config(font=("Times",15))
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="Prediction 3", command=NaiveBayes)
